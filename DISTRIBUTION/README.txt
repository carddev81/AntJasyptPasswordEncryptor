...
Current file in this directory (AntJasyptPasswordEncryptor\DISTRIBUTION\)
===============================================================
ant-jasypt-encryptor-1.x.jar
===============================================================
...
==================================================================================================================
ant-jasypt-encryptor-1.x.jar
		The ant-jasypt-encryptor-1.x.jar is used for generating encrypted passwords. An example of the usage of the 
		task is below
		...
		explanation of the above scripting is first the typedef task is called for setting up the jasyptencryptor by
		attempting to load the com.omo.tools.ant.AntJasyptPasswordEncryptor class. After the task has been defined then you are
		able to run the jasyptencryptor task.
==================================================================================================================
...
Parameters/Attributes
		...
		failonerror
			set this to true | false for failing on error during the decryption process
